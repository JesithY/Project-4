...
//             UserAccountsDrawerHeader(
//               accountName: const Text('No Profile'),
//               accountEmail: Text(widget.model.user.email ?? 'No Email Available'),
//               decoration: const BoxDecoration(
//                 color: Color.fromARGB(255, 78, 132, 177),
//               ),
//             ),
...
//                 child: Center(
//                   child: Text(
//                     widget.model.result.isEmpty ? '?' : '${widget.model.key}\n${widget.model.result}',
...
//                 children: [
//                   ElevatedButton(
//                     onPressed: widget.model.isPlayEnabled ? controller.playGame : null,
//                     child: const Text('Play'),
//                   ),
//                   ElevatedButton(
//                     onPressed: widget.model.isNewGameEnabled
...
//                     onChanged: widget.model.isBettingDisabled
//                         ? null
//                         : (value) => controller.selectBetType(widget.model.parseBetType(value)!),
//                   ),
//                   const Text('Odd'),
//                 ],
//               ),
...
//                   value: widget.model.betAmount,
//                   items: const [
//                      DropdownMenuItem<int?>(value: null, child: Text('Choose bet amount')),
//                      DropdownMenuItem(value: 10, child: Text('\$10')),
//                      DropdownMenuItem(value: 20, child: Text('\$20')),
//                      DropdownMenuItem(value: 30, child: Text('\$30')),
//                   ],
...
//                             widget.model.isPlayEnabled = value != null;
//                           });
//                         },
//                   hint: const Text('Choose bet amount'),
//                 ),
...
//               onChanged: widget.model.isBettingDisabled
//                   ? null
//                   : (value) => controller.selectBetRange(widget.model.parseBetRange(value)!),
//             ),
//             const Text('1-2'),
//             Radio(
//               value: BetRange.range3to4,
                ...
                child: DropdownButton<int?>(
                  ...
                  onChanged: widget.model.isBettingDisabled
                      ...
                      : (value) {
                          setState(() {
                            widget.model.betAmount = value;
                            widget.model.isPlayEnabled = widget.model.betAmount != null || widget.model.rangeBetAmount != null;
                          });
                        },
                  hint: const Text('Choose bet amount'),
                ),
